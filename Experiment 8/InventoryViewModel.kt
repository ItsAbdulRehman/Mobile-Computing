...
/**
 * ViewModel to keep a reference to the Inventory repository and an up-to-date list of all items.
 */
class InventoryViewModel(private val itemDao: ItemDao) : ViewModel() {
    ...
    private fun getNewItemEntry(itemName: String, itemPrice: String, itemCount: String): Item? {
        // Ensure valid data before creating the Item instance
        val price = itemPrice.toDoubleOrNull()
        val count = itemCount.toIntOrNull()
